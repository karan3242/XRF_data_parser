...
el = c(
       "Ac", "Ag", "Al", "As", "At", "Au", "Ba", "Bh", "Bi", "Br", "Ca", "Cd", "Ce", "Cl", "Cn", "Co", "Cr", "Cs", "Cu", "Db", "Ds", "Dy", "Er", "Eu", "Fe", "Fl", "Fr", "Ga", "Gd", "Ge", "Hf", "Hg", "Ho", "Hs", "I", "In", "Ir", "K", "La", "Lu", "Lv", "Mc", "Mg", "Mn", "Mo", "Mt", "Nb", "Nd", "Nh", "Ni", "Np", "Og", "Os", "P", "Pa", "Pb", "Pd", "Pm", "Po", "Pr", "Pt", "Pu", "Ra", "Rb", "Re", "Rf", "Rg", "Rh", "Ru", "S", "Sb", "Sc", "Se", "Sg", "Si", "Sm", "Sn", "Sr", "Ta", "Tb", "Tc", "Te", "Th", "Ti", "Tl", "Tm", "Ts", "U", "V", "W", "Y", "Yb", "Zn", "Zr"
)
